...
{
    public partial class Frm_MostrarConsulta8 : Form
    {
        private Helper oHelper = Helper.ObtenerInstancia();
        public Frm_MostrarConsulta8()
        {
            InitializeComponent();
        }
        ...
        private void CargarDGV()
        {
            ...
            tabla = oHelper.Consulta1("SP_Consulta8");

            dgv_out.DataSource = tabla;
        }

        private void Frm_MostrarConsulta8_Load(object sender, EventArgs e)
        {
            CargarDGV();
        }
