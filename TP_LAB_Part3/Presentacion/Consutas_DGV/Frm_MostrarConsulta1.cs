...
{
    public partial class Frm_MostrarConsulta1 : Form
    {
        private Helper oHelper = Helper.ObtenerInstancia();
        public Frm_MostrarConsulta1()
        {
            InitializeComponent();
        }
        ...
        private void CargarDGV()
        {
            ...
            tabla = oHelper.Consulta1("SP_Consulta1");

            dgv_out.DataSource = tabla;
        }

        private void Frm_MostrarConsulta1_Load(object sender, EventArgs e)
        {
            CargarDGV();
        }
